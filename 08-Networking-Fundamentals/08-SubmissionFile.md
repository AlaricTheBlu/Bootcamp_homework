...
### Phase 3: DNS
 ...
 - The address in the cache does not match the address from nslookup. This means that the hollywood server has likely been the victim of a DNS hijacking attack. A malicious user or a hacker likely accessed the DNS cache to send anyone going to rollingstone.com to the other ip.
